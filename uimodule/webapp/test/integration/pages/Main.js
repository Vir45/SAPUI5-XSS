sap.ui.require([
    ...
    Opa5.createPageObjects({
        onTheMainPage: {
            viewName: "security.demo.securityDemo.view.MainView",
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of security.demo.securityDemo"
                        },
                        success: function() {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title security.demo.securityDemo"
                    });
                }
            }
